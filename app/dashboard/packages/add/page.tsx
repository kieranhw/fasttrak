  ...
  async function confirmPackage(values: z.infer<typeof PackageSchema>, resultSender: google.maps.GeocoderResult[], resultRecipient: google.maps.GeocoderResult[]) {
    const { error } = await supabase
      ...
      .insert({
        ...
        recipient_address_location: `{${resultRecipient[0].geometry.location.lat()},${resultRecipient[0].geometry.location.lng()}}`,
        sender_name: values.sender_name,
        sender_phone: values.sender_phone,
        sender_address: resultSender[0].formatted_address,
        sender_address_location: `{${resultSender[0].geometry.location.lat()},${resultSender[0].geometry.location.lng()}}`,
        status: "Pending",
